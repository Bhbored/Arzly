...
{
    /// <inheritdoc />
    public partial class ActivateNotifications : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_AspNetUsers_ChatterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ChatterId",
                table: "Notifications",
                column: "ChatterId");
