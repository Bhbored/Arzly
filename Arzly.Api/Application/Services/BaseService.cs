...
namespace Arzly.Api.Application.Services
{
    ...
    where TUpdateDto : class
    {
        ...
        public virtual async Task<TDto?> CreateAsync(TCreateDto? createDto, TKey? userId)
        {
            if (createDto == null)
        ...
        public virtual async Task<TDto?> UpdateAsync(TUpdateDto? updateDto, TKey? userId)
        {
            if (updateDto == null)
