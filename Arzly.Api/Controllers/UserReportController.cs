...
namespace Arzly.Api.Controllers
{
    ...
    public class UserReportController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<UserReportResponse>> Create([FromBody] UserReportAddRequest createDto, [FromHeader] string? userId)
        {
        ...
        [HttpPut("[action]")]
        public async Task<ActionResult<UserReportResponse>> Update([FromBody] UserReportUpdateRequest updateDto, [FromHeader] string? userId)
        {
