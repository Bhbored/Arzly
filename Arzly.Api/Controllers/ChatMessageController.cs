...
namespace Arzly.Api.Controllers
{
    ...
    public class ChatMessageController : ControllerBase
    {
        ...
        public ChatMessageController(IChatMessageService service, ILogger<ChatMessageController> logger)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpGet]
        public virtual async Task<ActionResult<List<ChatMessageResponse>>> GetAll()
        {
            try
            {
            ...
            {
                _logger.LogError(ex, "Error in ChatMessageController.GetAll");
                return StatusCode(500, "Internal server error");
            }
        }

        [HttpGet("{id:guid}")]
        public async Task<ActionResult<ChatMessageResponse>> GetById(Guid? id)
        {
            try
            {
            ...
            {
                _logger.LogError(ex, "Error in ChatMessageController.GetById");
                return StatusCode(500, "Internal server error");
            }
        }

        [HttpPost("[action]")]
        [TypeFilter(typeof(ModelBindingFilter), Arguments = new object[] { typeof(ChatMessageController) })]
        public async Task<ActionResult<ChatMessageResponse>> Create([FromBody] ChatMessageAddRequest? request)
        {
            try
            {
            ...
            {
                _logger.LogError(ex, "Error in ChatMessageController.Create");
                return StatusCode(500, "Internal server error");
            }
        }
        ...
        [TypeFilter(typeof(ModelBindingFilter), Arguments = new object[] { typeof(ChatMessageController) })]
        public async Task<ActionResult<ChatMessageResponse?>> Update([FromBody] ChatMessageUpdateRequest? request)
        {
            try
            {
            ...
            {
                _logger.LogError(ex, "Error in ChatMessageController.Update");
                return StatusCode(500, "Internal server error");
            }
        }
        ...
        public async Task<ActionResult> Delete(Guid? id)
        {
            ...
            {
                _logger.LogError(ex, "Error in ChatMessageController.Delete");
                return StatusCode(500, "Internal server error");
            }
        }
    }
